export const BLOCK_EXPLORER_URL = process.env.REACT_APP_BLOCK_EXPLORER_URL || 'https://explorer.zircuit.com'
...
export const SWAP_LINK = process.env.REACT_APP_SWAP_LINK || 'https://zircuit-swap.w3us.site'
